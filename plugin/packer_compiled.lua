...
_G.packer_plugins = {
  ...
  ["vim-AtLas"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-AtLas",
    url = "https://github.com/FesaGemini/vim-AtLas"
  },
  ["vim-prettier"] = {
    loaded = true,
  ...
  ["vim-which-key"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-which-key",
